public class Student {
    ...
    public String getStudentInfo() {
        String t = "Student Full Name: " + firstName + " " + lastName + "\n";
        t += "Graduation Year: " + gradYear +"\n";
        t+="Number of tests: "+testScoreCount+"\n";
        t+="Average Test Score: "+averageTestScore()+"\n";
        t+="Is passing: "+isPassing();
        return t;
    }
